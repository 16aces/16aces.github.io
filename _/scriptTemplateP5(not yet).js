...
Fractions.prototype.subtract=function(){
   ...
   // test=box1.demoniator; 
   //test=this.box2.denominator;
...
Fractions.prototype.divide=function(){
    test=0;
    for(var x = this.box1.denominator; x +  this.box2.denominator > 0; x -= this.box2.denominator){
        test++;
...
Fractions.prototype.update=function(){
    ...
    if(this.math==="add"){
        ...
        if (this.step===5){
            while(this.box1.numerator>0){
               this.subtract();
               this.box2=this.newbox2.clone();
            }
    ...
    else if(!this.box1.moveBox[0]&&!this.box2.moveBox[0]&&this.movebox[0]){
...
//fractions.add();
//test=box1.);
//box1.move(8,box2.squares[4]);

/////////////////////////////////////////////////////////////////////////////////// DRAW ////////////////////////////////////////////////////////////////////////////////////////////////////
//test=moveBox.squares.length;
function draw() {
   // box1.update();
   // test=test;
  /* if(frameCount%300===0){
   ...
   //test=fractions.box1.squares.length;
   //test=box1.squares[8].x;
   //test=fractions.box2.moveBox.length;
   //test=fractions.movebox.length;
   //test=fractions.step;
   //test=fractions.box1.squares.length;
